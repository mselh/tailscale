...
func TestVMIntegrationEndToEnd(t *testing.T) {
	...
	distros := []Distro{
		// NOTE(Xe): If you run into issues getting the autoconfig to work, comment out all the other distros and uncomment this one.
		...
		//
		// Login as root with the password root. Then look in /var/log/cloud-init-output.log for what you messed up.
